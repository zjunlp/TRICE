...
def train(
    ...
    if resume_from_checkpoint:
        ...
        if os.path.exists(checkpoint_name):
            ...
            adapters_weights = torch.load(checkpoint_name, map_location=model.device)
    ...
    if data_path.endswith(".json") or data_path.endswith(".jsonl"):
        # data_path=[data_path]
        # for i in os.listdir('../sampled-v2/'):
            # data_path.append(os.path.join('../sampled-v2/',i))
        # for i in os.listdir('../use/'):
        #     data_path.append(os.path.join('../use/',i))
